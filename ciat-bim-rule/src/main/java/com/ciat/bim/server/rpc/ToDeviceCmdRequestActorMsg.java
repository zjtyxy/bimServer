...
public class ToDeviceCmdRequestActorMsg implements ToDeviceActorNotificationMsg {
    ...
    @Getter
    private final ToDeviceCmdRequest msg;
    ...
    public MsgType getMsgType() {
        return MsgType.DEVICE_CMD_REQUEST_TO_DEVICE_ACTOR_MSG;
    }
}
