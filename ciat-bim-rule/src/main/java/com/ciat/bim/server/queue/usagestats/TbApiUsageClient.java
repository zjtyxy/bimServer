...
public interface TbApiUsageClient {
    ...
    void report(String tenantId, CustomerId customerId, ApiUsageRecordKey key, long value);

    void report(String tenantId, CustomerId customerId, ApiUsageRecordKey key);
