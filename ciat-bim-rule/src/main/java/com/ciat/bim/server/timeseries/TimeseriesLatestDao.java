...
public interface TimeseriesLatestDao {
    ...
    ListenableFuture<TsKv> findLatest(TenantId tenantId, EntityId entityId, String key);

    ListenableFuture<List<TsKv>> findAllLatest(TenantId tenantId, EntityId entityId);

    ListenableFuture<Void> saveLatest(TenantId tenantId, EntityId entityId, TsKv tsKvEntry);
