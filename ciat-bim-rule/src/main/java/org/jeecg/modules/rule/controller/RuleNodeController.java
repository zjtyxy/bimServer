...
@Api(tags="规则节点")
@RestController
@RequestMapping("/rule/ruleNode")
@Slf4j
public class RuleNodeController extends JeecgController<RuleNode, IRuleNodeService> {
	@Autowired
	 ...
	 * @return
	 */
	@AutoLog(value = "规则节点-分页列表查询")
	@ApiOperation(value="规则节点-分页列表查询", notes="规则节点-分页列表查询")
	@GetMapping(value = "/list")
	public Result<?> queryPageList(RuleNode ruleNode,
	...
	public Result<?> add(@RequestBody RuleNode ruleNode) {
	...
	public Result<?> edit(@RequestBody RuleNode ruleNode) {
	 ...
	 * @return
	 */
	@AutoLog(value = "规则节点-通过id查询")
	@ApiOperation(value="规则节点-通过id查询", notes="规则节点-通过id查询")
	@GetMapping(value = "/queryById")
	public Result<?> queryById(@RequestParam(name="id",required=true) String id) {
		RuleNode ruleNode = ruleNodeService.getById(id);
		if(ruleNode==null) {
			return Result.error("未找到对应数据");
		}
		return Result.OK(ruleNode);
	}
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, RuleNode ruleNode) {
        return super.exportXls(request, ruleNode, RuleNode.class, "规则节点");
    }
    ...
    */
    ...
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
        return super.importExcel(request, response, RuleNode.class);
    }
