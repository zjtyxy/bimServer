...
var haoutil = haoutil || {};
haoutil.version = "2.4", haoutil.name = "木遥 通用常用JS方法类库", haoutil.author = "木遥（QQ：346819890） https://github.com/muyao1987/haoutil", haoutil.msg = function (t) {
    window.toastr ? toastr.info(t) : window.layer ? layer.msg(t) : alert(t)
}, haoutil.tip = haoutil.msg, haoutil.oneMsg = function (t, e) {
    ...
    return {
        isH5Mobile: function (t) {
            ...
            if (i && null != window.plus) plus.navigator.removeCookie(t); else {
                var e = new Date;
    ...
    return {
        isNull: r, isNotNull: function (t) {
            ...
            return "object" == _typeof(t) && t.constructor == Array
        }, isString: e, isNumber: n, isDate: function (t) {
            return "object" == _typeof(t) && t.constructor == Date
    ...
    var o = document.head || document.getElementsByTagName("head")[0], i = new RegExp("\\.css");
    return {
        getRequest: function () {
        ...
        }, loadCss: n, loadJs: r, loadResource: function (t, e) {
