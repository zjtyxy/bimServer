!function (e, n, o) {
    ...
    o.ctx = t.$.ctx, o.colors = t.$.colors, o.po = t.$.po, o.storage = t.$.storage, o.sessionStorage = t.$.sessionStorage, o.site = t.$.site, o.site && o.site.contentTabs && o.site.contentTabs.ifameTabs(n), o.configs = t.$.configs, t.$.components && t.$.components.init(n, e), e.Breakpoints = t.Breakpoints, e.toastr = t.toastr, e.layer = t.layer, e.haoutil = t.haoutil, e.notifyFn = t.$.notifyFn;
    var i = i || {};
    o.extend(i, {
        _queue: {prepare: [], run: [], complete: []}, run: function () {
            ...
            var n = this, i = this._getQueue(e).shift();
            ...
            return o.each(this._queue, function (e, t) {
                o.isFunction(n[e]) && (t.unshift(n[e]), delete n[e])
            }), o.extend(this, n), this
    ...
    var s = {
        pageAside: function () {
            var e = o(".page-aside"), t = e.hasClass("open");
